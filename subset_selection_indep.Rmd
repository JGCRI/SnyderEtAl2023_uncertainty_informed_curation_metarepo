...
write_dir <- 'subset_summary_metrics_indep/'
...
subset_ineligible <- c() # all models eligible following values sourced from Zelinka
...
p_coefs <- ggplot(data = grid_plot) +
    ...
    #            size = 2) +
     ggtitle(paste('Projection of ESM data into the first five eigenvectors\n',
                  fig_dir)) +
