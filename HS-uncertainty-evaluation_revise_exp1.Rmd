---
title: "HS uncertainty evalution Experiment 1 - all models"
author: "acs"
output: 
  html_document:
    toc: true
...
ggsave(paste0(fig_dir, 'temperature_exp1_', rms_cutoff,'_HS_regions.png'), p_tas, width = 12, height =8, units = 'in')
...
ggsave(paste0(fig_dir, 'precipitation_exp1_', rms_cutoff,'_HS_regions.png'), p_pr, width = 12, height =8, units = 'in')
