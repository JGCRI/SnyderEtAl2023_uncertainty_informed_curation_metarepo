---
title: "HS uncertainty evalution Experiment 1 - adding TP values, all models"
author: "acs"
output: 
  html_document:
    toc: true
...
# filter to exp1 and to the files for the subset constraining ECS dist
...
p_tas <- ggplot()+
    ...
    ggtitle(paste('Temperature Experiment 1, rms >', rms_cutoff)) +
    theme_bw() +
...
ggsave(paste0(fig_dir, 'temperature_exp1_', rms_cutoff,'_HS_regions.png'), p_tas, width = 8, height =6, units = 'in')
...
p_pr <- ggplot()+
    ...
    facet_wrap(~rgn, ncol=6) +
    theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
    ggtitle(paste('Precipitation Experiment 1, rms >', rms_cutoff))+
    theme_bw() +
     theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
           axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
           axis.title = element_text(size = axis_size), 
...
ggsave(paste0(fig_dir, 'precipitation_exp1_', rms_cutoff,'_HS_regions.png'), p_pr, width = 8, height =6, units = 'in')
...
p_map <- ggplot() +
  ...
  #ggtitle('coef') + 
    ...
    ggtitle(paste('Experiment 1, rms cutoff', rms_cutoff))
