...
ggsave(paste0(fig_dir, 'temperature_exp2_', rms_cutoff,'_HS_regions.png'), p_tas, width = 8, height = 8, units = 'in')
...
ggsave(paste0(fig_dir, 'precipitation_exp2_', rms_cutoff,'_HS_regions.png'), p_pr, width = 8, height = 8, units = 'in')
